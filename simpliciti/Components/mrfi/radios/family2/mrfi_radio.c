...
// [BM] Need this prototype declaration due to strict prototyping turned on
...
// [BM] Frequency offset set during calibration
extern uint8_t frequoffset;
...
void MRFI_Init(void)
{
  ...
  // [BM] Fine-tune synthesizer with global calibration value  
  FSCTRL0  = frequoffset;
 ...
 **************************************************************************************************
 */
// [BM] Function is called from application RF_VECTOR ISR  
