...
unsigned char message_length = USB_MAX_MESSAGE_LENGTH;
unsigned char usb_buffer[USB_MAX_MESSAGE_LENGTH+2];
char          usb_bufferIndex = 0;
unsigned char usb_newdata = 0;
unsigned char usb_sendack = 0;
