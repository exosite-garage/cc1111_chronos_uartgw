...
+------------------------------------------------------------------------------
|   File:      hal.h
|   Target:    cc2430, cc2431, cc1110, cc2510, cc2511, cc1111
|   Author:    EFU/ KJA / TBR
|   Revised:   2007-09-21
|   Revision:  1.0
|   Description:
...
*
******************************************************************************/
__near_func BOOL utilEnterCriticalSection(void);
...
*
******************************************************************************/
__near_func void utilLeaveCriticalSection(BOOL oldStatus);
#endif
